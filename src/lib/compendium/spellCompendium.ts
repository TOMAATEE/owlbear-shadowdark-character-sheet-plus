...
export const SPELLS: SpellInfo[] = [
    ...
    },
    {
        ...
        desc: "One creature you touch gains 1d6 temporary HP for the spell's duration. You cannot target the same creature with this spell again until its effects end.",
        duration: {type: "Round", amt: 5},
    },
    {
        name: "Hold Portal",
    ...
    },
    {
        ...
        alignment: "Lawful",
        tier: 1,
        desc: "You say a prayer over one creature, granting it resolve. The next time the target fails an attack roll during this spell's duration, it succeeds instead and this spell ends. You cannot target the same creature with this spell again until its effects end.",
        duration: {type: "Round", amt: 5},
    },
    {
    ...
    },
    {
        ...
        desc: "A weapon or suit of armor you touch sprouts dense thorns. Weapons become magical and deal +1d4 damage for the spell's duration. Armor becomes magical and deals 1d4 damage to anyone who touches its wearer for the spell's duration. If your deity is Gede, cast this spell with ADV.",
        duration: {type: "Round", amt: 5},
    },
    {
        name: "Ward",
    ...
    },
    {
        ...
        alignment: "Lawful",
        tier: 2,
        desc: "A near-sized area around where you cast this spell becomes sanctified with a holy blessing. Chaotic creatures of LV 4 or less cannot physically enter this area for the spell's duration. If your deity is Saint Terragnis, cast this spell with ADV.",
        duration: {type: "Instant"},
    },
    {
    ...
    },
    {
        ...
        alignment: "Chaotic",
        tier: 2,
        desc: "A creature you touch is compelled to tell you its secrets. On its turn, the target tells you the secret it holds most dear that you do not already know. If your deity is Shune the Vile, cast this spell with ADV.",
        duration: {type: "Instant"},
    },
    {
        name: "Fate",
    ...
    },
    {
        ...
        desc: "All food within near of you is blessed by Gede's bounty. Creatures who willingly join you in eating the food who are not friendly toward you become so for one day. This effect ends if you do anything to harm them. Creatures who are already friendly toward you regain 1d6 HP and may make an additional check to end any poisons or diseases affecting them. Uneaten food loses the effects of this spell after the meal is over.",
        duration: {type: "Instant"},
    },
    {
        name: "Fixed Object",
    ...
    },
    {
        ...
        alignment: "Lawful",
        tier: 2,
        desc: "You calm the anger and hostility of all creatures of LV 4 or less within near range. These creatures will not attack you or your allies for the spell's duration. This spell ends if the creatures notice any attempts to harm them. When this spell ends, the creatures revert to their original dispositions.",
        duration: {type: "Round", amt: 5},
    },
    {
        name: "Phantoms",
    ...
    },
    {
        ...
        alignment: "Chaotic",
        tier: 3,
        desc: "You enter a supernatural rage. For the spell's duration, you have ADV on melee attacks, and your attacks deal +1d8 damage. You must make a melee attack against the creature nearest to you on your turn, even if it's an ally. If you cannot, the spell ends. If your deity is Ramlaat, cast this spell with ADV.",
        duration: {type: "Round", amt: 5},
    },
    {
        name: "Broomstick",
    ...
    },
    {
        ...
        alignment: "Chaotic",
        tier: 3,
        desc: "You become a conduit of pure chaos, shredding all organized magic around you. For the spell's duration, you are immune to all spells and magical effects from lawful sources. If your deity is Memnon, cast this spell with ADV.",
        duration: {type: "Round", amt: 5},
    },
    {
        name: "Revitalize",
    ...
    },
    {
        ...
        alignment: "Neutral",
        tier: 4,
        desc: "You and your gear transform into a bear of your choice for the spell's duration. You assume the bear's STR, DEX, CON, HP, AC, speed, attacks, and physical characteristics, but retain your INT, WIS, and CHA. You can cast spells in this form. If you go to 0 HP, you revert to your true shape at 0 HP.",
        duration: {type: "Round", amt: 10},
    },
    {
        name: "Beguile",
    ...
    },
    {
        ...
        alignment: "Chaotic",
        tier: 4,
        desc: "A creature you touch is inflicted with a horrible wasting disease. Choose a stat. The target must pass a DC 15 CON check each day or lose 1d6 points from this stat. The target dies when the stat reaches 0.",
    ...
    },
    {
        ...
        alignment: "Chaotic",
        tier: 4,
        desc: "One creature in range of LV 5 or less descends into total madness. It spends its turn raving and stalking around uselessly. If you successfully focus on this spell for 3 rounds in a row, the madness becomes permanent. If your deity is The Lost, cast this spell with ADV.",
        duration: {type: "Focus"},
    },
    {
        name: "Wall Of Force",
    ...
    },
    {
        ...
        tier: 4,
        effect: {type: "Damage", diceType: "d6", numDice: 3},
        desc: "You summon a blazing wheel of flames and eyes that envelops one creature in holy energy. The target takes 3d6 damage. If the target is a demon or devil, it must pass a DC 15 CHA check or be paralyzed for 3 rounds.",
        duration: {type: "Instant"},
    },
    {
        name: "Wrath",
    ...
    },
    {
        ...
        alignment: "Chaotic",
        tier: 5,
        desc: "Choose one creature in range of LV 10 or less. You can only target the same creature with this spell one time. The creature is cast into your god's domain. Unless the creature is a worthy follower of your god, it is trapped there to suffer eternal punishment. You cannot cast this spell again until you complete penance.",
        duration: {type: "Instant"},
    },
    {
        name: "Death Ward",
    ...
    },
    {
        ...
        alignment: "Lawful",
        tier: 5,
        desc: "The searing light of Law itself blazes out from you, washing over everything in sight. All other creatures of LV 15 or less in range must pass a DC 15 CHA check or be permanently rendered mute and blind. You cannot cast this spell again until you complete penance.",
        duration: {type: "Instant"},
    },
    {
        name: "Root",
        ...
        alignment: "Neutral",
        tier: 5,
        desc: "One creature you touch is immune to damage for the spell's duration. You cannot cast this spell again until you complete penance.",
        duration: {type: "Focus"},
    },
    {
        name: "Scrying",
